        ...
        <Suspense fallback={null} >
            ...
            <Canvas  camera={{ position: [0,0,1], fov: 100 }}>
                ...
                <Suspense fallback={null}>
                    ...
                    <ThreeModel
                    modelType={animation.raw_animation_type ? animation.raw_animation_type : ""}
                    modelUrl={animation.animation ? animation.animation : "" }
                    mtlUrl={animation.isMTLForm ? animation.isMTLForm : ""} 
